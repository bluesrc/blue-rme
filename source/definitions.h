...
#define __W_RME_APPLICATION_NAME__ wxString("Blue Map Editor")
#define __RME_APPLICATION_NAME__ std::string("Blue Map Editor")
...
#define __SITE_URL__ "https://github.com/bluesrc/blue-rme"
